import os   
os.environ['CUDA_VISIBLE_DEVICES'] = '1'    #### specify gpu_id

def warn(*args, **kwargs):
    pass
import warnings
warnings.warn = warn
from model import CVTGAD
...
# from plot_TSNE import tsne_plot_x1_x2, tsne_plot_x_y, plot_score_true_2D
...
if __name__ == '__main__':
    ...
    for trial in range(args.num_trial):
        ...
        model = CVTGAD(args.hidden_dim, args.num_layer, dataset_num_features, args.dg_dim+args.rw_dim, args).to(device)
